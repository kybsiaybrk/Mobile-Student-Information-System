...
public class DonemDersleriAdapter extends RecyclerView.Adapter<DonemDersleriAdapter.DersViewHolder> {
    private List<String> dersListesi;

    public DonemDersleriAdapter(List<String> dersListesi) {
    ...
    public DersViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_dersbudonem, parent, false);
