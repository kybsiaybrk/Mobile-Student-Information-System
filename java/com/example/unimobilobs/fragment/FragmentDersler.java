...
public class FragmentDersler extends Fragment {

    private RecyclerView recyclerView;
    private DonemDersleriAdapter dersAdapter;
    private List<String> dersListesi;
    private static final String TAG = "FragmentBuDonemDersler";

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_dersler, container, false);

        recyclerView = view.findViewById(R.id.recyclerViewBuDonemDersler);
